        ...
        <div className="relative z-10 pb-24 md:pb-32 px-6 md:px-12 lg:px-24">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="h-px w-16 bg-[hsl(var(--dest-primary))]" />
              <span className="text-xs tracking-[0.5em] uppercase text-[hsl(var(--dest-primary))] font-body font-medium">
                Maximum Impact Travel
              </span>
            </div>

            {/* Main Title - Editorial Style */}
            <h1 className="font-heading text-6xl md:text-8xl lg:text-[10rem] font-semibold text-foreground leading-[0.85] tracking-tight mb-8">
              {config.destinationName}
            </h1>

            {/* Subtitle as editorial tagline */}
            <p className="font-heading text-2xl md:text-3xl lg:text-4xl text-foreground/80 max-w-2xl italic">
              {config.tagline}
            </p>
          </motion.div>
        </div>
