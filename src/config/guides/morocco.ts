...
export const moroccoGuide: GuideConfig = {
  ...
  images: {
    ...
    interludes: {
      ...
      afterBasics: [rooftopBreakfast, mintTea, teaConversation],
      afterCulture: [lanternShopping, spiceMarket, boutiqueLaughing],
      afterPhotos: [majorelleGarden, casablancaMosque, mosqueInterior],
      afterRealTalk: [desertCamp, jemaaElFna, welcomeImage],
    },
    strips: {
      safari: [
        { src: saharaSunsetWalker, caption: 'Sahara sunset walk' },
        { src: camelCaravan, caption: 'Camel caravan' },
        { src: desertCamp, caption: 'Luxury desert camp' },
        { src: saharaDuneDusk, caption: 'Dunes at dusk' },
      ],
      beach: [
        { src: casablancaMosque, caption: 'Hassan II Mosque' },
        { src: mosqueInterior, caption: 'Mosque interior' },
        { src: majorelleGarden, caption: 'Majorelle Garden' },
        { src: jemaaElFna, caption: 'Jemaa el-Fna' },
      ],
      culture: [
        { src: lanternShopping, caption: 'Lantern shopping' },
        { src: spiceMarket, caption: 'Spice market' },
        { src: mintTea, caption: 'Mint tea ceremony' },
        { src: teaConversation, caption: 'Tea conversation' },
        { src: boutiqueLaughing, caption: 'Boutique exploration' },
