...
export const egyptGuide: GuideConfig = {
  ...
  images: {
    ...
    interludes: {
      ...
      afterBasics: [feluccaSunset, cruiseContemplation, welcomeImage],
    ...
    strips: {
      safari: [
        { src: firstPyramidView, caption: 'First pyramid view' },
        { src: pyramidTouch, caption: 'Touching history' },
        { src: sphinxCouple, caption: 'With the Sphinx' },
        { src: gizaGroup, caption: 'Group at Giza' },
        { src: abuSimbelApproach, caption: 'Abu Simbel approach' },
        { src: abuSimbelScale, caption: 'Ramesses II\'s temple' },
        { src: balloonValley, caption: 'Balloon over Valley of Kings' },
        { src: hatshepsutTemple, caption: 'Hatshepsut Temple' },
      ],
      beach: [
        { src: feluccaNile, caption: 'Felucca on the Nile' },
        { src: feluccaSunset, caption: 'Sunset sailing' },
        { src: cruiseContemplation, caption: 'Cruise contemplation' },
        { src: foodImage, caption: 'Cruise dinner' },
        { src: welcomeImage, caption: 'Nile sunset moment' },
      ],
      culture: [
        { src: nubianWelcome, caption: 'Nubian welcome' },
        { src: nubianTea, caption: 'Tea with locals' },
        { src: nubianVillage, caption: 'Nubian village colors' },
        { src: nubianHouse, caption: 'Nubian house' },
        { src: cultureImage, caption: 'Khan el-Khalili' },
