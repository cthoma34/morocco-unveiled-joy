...
// New images - Ship & Cruise Experience
...
export const caribbeanGuide: GuideConfig = {
  ...
  culture: { 
    ...
    food: { 
      ...
      items: [
        { name: 'Jerk Everything (Jamaica)', description: 'Spiced, smoked perfection', mustTry: true, image: jerkStand }, 
        { name: 'Flying Fish (Barbados)', description: 'National dish with cou cou', mustTry: true, image: flyingFish }, 
        { name: 'Doubles (Trinidad)', description: 'Curried chickpeas in fried bread', mustTry: true, image: doubles }, 
  ...
  images: { 
    ...
    strips: {
      shipLife: [
        { src: embarkationBoarding, caption: 'Embarkation Day' },
        { src: balconySunrise, caption: 'Sunrise at Sea' },
        { src: poolDeck, caption: 'Pool Deck Paradise' },
        { src: formalDinner, caption: 'Elegant Dining' },
        { src: shipTheater, caption: 'Broadway at Sea' },
        { src: spaTreatment, caption: 'Ocean View Spa' },
      ],
      islandLife: [
      ...
      culture: [
        { src: steelDrums, caption: 'Steel Pan Rhythms' },
        { src: reggaeBar, caption: 'Jamaica Vibes' },
        { src: jerkStand, caption: 'Authentic Jerk' },
    ...
    interludes: { 
      ...
      afterBasics: [poolDeck, beachShipView], 
      afterCulture: [steelDrums, reggaeBar] 
    } 
  },
};
